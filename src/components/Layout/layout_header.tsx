  ...
  return (
    <div className="h-16 w-full flex justify-between border-b border-border-subtle px-4">
      ...
      <div className="flex gap-2 items-center ">
        ...
        <div className="bg-red-500 rounded-full size-9 flex items-center justify-center border border-border-subtle hover:border-border-focus cursor-pointer transition-colors duration-200">
          Sd
        </div>
      </div>
    </div>
